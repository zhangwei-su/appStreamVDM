  ...
  private final PayloadCallback mPayloadCallback =
      new PayloadCallback() {
        ...
        public void onPayloadReceived(String endpointId, Payload payload) {
          logD(String.format("onPayloadReceived(endpointId=%s, payload=(%d)))", endpointId,
                  payload.getId()));
        ...
        public void onPayloadTransferUpdate(String endpointId, PayloadTransferUpdate update) {
          logD(
              String.format(
                  "onPayloadTransferUpdate(endpointId=%s, update=(%d:%d:%d / %d)", endpointId,
                      update.getPayloadId(), update.getStatus(),
